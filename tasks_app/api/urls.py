...
from .views import PostTaskView, TaskAssigneeList, DeleteCommentView, TaskCommentView, UpdateDeleteTaskView, TasksReviewingList


urlpatterns = [
    path('tasks/', PostTaskView.as_view()),
    path('tasks/assigned-to-me/', TaskAssigneeList.as_view()),
